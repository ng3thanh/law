    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <h1 class="brand"><a href="{{ route('main') }}">Maxim</a></h1>
                <!-- navigation -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span2 offset1 flyIn">
                <div class="people">
                    <img class="team-thumb img-circle" src="{{ asset('web/img/team/img-1.jpg') }}" alt="" />
                    <h3>John Doe</h3>
                    <p>
                        Art director
                    </p>
            ...
            <div class="span2 flyIn">
                <div class="people">
                    <img class="team-thumb img-circle" src="{{ asset('web/img/team/img-2.jpg') }}" alt="" />
                    <h3>Mike Doe</h3>
                    <p>
                        Web developer
                    </p>
            ...
            <div class="span2 flyIn">
                <div class="people">
                    <img class="team-thumb img-circle" src="{{ asset('web/img/team/img-3.jpg') }}" alt="" />
                    <h3>Neil Doe</h3>
                    <p>
                        Web designer
                    </p>
            ...
            <div class="span2 flyIn">
                <div class="people">
                    <img class="team-thumb img-circle" src="{{ asset('web/img/team/img-4.jpg') }}" alt="" />
                    <h3>Mark Joe</h3>
                    <p>
                        UI designer
                    </p>
            ...
            <div class="span2 flyIn">
                <div class="people">
                    <img class="team-thumb img-circle" src="{{ asset('web/img/team/img-5.jpg') }}" alt="" />
                    <h3>Stephen B</h3>
                    <p>
                        Digital imaging
                    </p>
            ...
            <div class="span12">
                <div id="portfolio-wrap">
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="{{ asset('web/img/works/big.jpg') }}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="{{ asset('web/img/works/6.png') }}" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="{{ asset('web/img/works/big.jpg') }}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="{{ asset('web/img/works/7.png') }}" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography">
                        <div class="portfolio">
                            <a href="{{ asset('web/img/works/big.jpg') }}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="{{ asset('web/img/works/8.png') }}" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="{{ asset('web/img/works/big.jpg') }}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="{{ asset('web/img/works/9.png') }}" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid design web">
                        <div class="portfolio">
                            <a href="{{ asset('web/img/works/big.jpg') }}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="{{ asset('web/img/works/10.png') }}" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
