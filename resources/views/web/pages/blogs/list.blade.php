...
@section('content')
    <div id="blog-list">
        <div class="container header-padding-top">
            <div class="row" id="blog-title-all">Blog list</div>
                            ...
                            <div class="post col-xl-4">
                                <div class="pre-content">
                                    ...
                                    <div class="post-details blog-detail">
                                        ...
                                        <a class="blog-title" href="{{ route('blogs.detail', ['id' => $blog->id, 'slug' => $blog->slug]) }}">
                                        ...
                                        <a href="{{ route('blogs.detail', ['id' => $blog->id, 'slug' => $blog->slug]) }}" class="blog-more">{{ __('homepage.continue_reading') }}</a>
