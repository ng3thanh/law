                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_en">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <input type="text" id="title-en" name="trans[en][title]" max="200" maxlength="200" data-rule-required="true" class="form-control" placeholder="Title ..." value="{{ $titleEn }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <input type="text" id="slug-en" name="trans[en][slug]" max="200" maxlength="200" data-rule-required="true" class="form-control" value="{{ $slugEn }}">
                                ...
                                <div class="tab-pane" id="tab_vn">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"> Title <span class="span-red">*</span></label>
                                        <div class="col-sm-9 input-group">
                                            <input type="text" id="title-vn" name="trans[vi][title]" max="200" maxlength="200" class="form-control" data-rule-required="true" placeholder="Title ..." value="{{ $titleVn }}">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"> Slug <span class="span-red">*</span></label>
                                        <div class="col-sm-9 input-group">
                                            <input type="text" id="slug-vn" name="trans[vi][slug]" max="200" maxlength="200" class="form-control" data-rule-required="true" value="{{ $slugVn }}">
